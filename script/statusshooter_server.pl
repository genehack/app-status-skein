...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{STATUSSHOOTER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{STATUSSHOOTER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
statusshooter_server.pl - Catalyst Testserver

=head1 SYNOPSIS

statusshooter_server.pl [options]
