...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{STATUSSKEIN_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{STATUSSKEIN_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
statusskein_server.pl - Catalyst Testserver

=head1 SYNOPSIS

statusskein_server.pl [options]
